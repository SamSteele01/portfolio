  ...
  render() {
    return (
      <div className="project">
        ...
        <Single title={this.state.title1} image={this.state.image1} placeholder={placeholder} link={this.state.link1} text={projectText[1]}/>
        <Single title={this.state.title2} image={Image2} placeholder={placeholder} link={this.state.link2} text={projectText[2]}/>
